/* Copyright 2025 @alg/isbn/legacy contributors
 *
...
/**
 * Metadata associated with ISBN values as defined by the ISO 2108:2005 (ISBN)
 * standard.
 *
 * Allows for validating and parsing ISBN-13s and ISBN-10s into GS1, group,
 * registrant, publication, anc check digit elements.
 *
...
export class ISBN {
     ...
     * validated according to the ISO 2108:2005 (ISBN) standard.
     *
     ...
     * given ISBN falls under the allocated registrant ranges for the given
     * group.
     *
     * ISBNs can be formatted as, for example:
     * - A String of digits: `9780140447934`
     * - A human-readable form: `ISBN-13 978-0-140-44793-4` or
     *   `978 0 140 44793 4`
     ...
     * DOI, etc. — only that the group and registrant numbers have been
     * allocated by the ISBN Registration Authority and that the check-digit is
     * valid as defined by the ISO 2108:2005 (ISBN) standard.
     *
     ...
     * @example Valid ISBN
     * ```javascript
     * import {ISBN} from "@alg/isbn/legacy";
     *
     ...
     *
     * If the given string cannot be validated according to the ISO 2108:2005
 ...
 * ISO 2108:2005 and False otherwise.
 *
 ...
 * @example
 * ```javascript
 * import * as isbn from "@alg/isbn/legacy";
 *
 ...
 * the ISBN adders to the check-digit calculation defined by the ISO 2108:2005
 * (ISBN) standard.
 *
 * @param {string} string
 * @returns boolean
...
/**
 * Calculates the check digit for 12 or 9 digits of an ISBN
 *
